...
<ul class="pagination justify-content-center">
    ...
    echo '<li class="page-item"><a class="page-link" href="?menuop=eventos&paginaMedico=1">Primeira Pagina</a></li>';

    if ($pagina > 6) {
    ?>
        <li class="page-item"><a class="page-link" href="?menuop=eventos&paginaMedico=<?php echo $pagina - 1 ?>">
                <<< /a>
        </li>
    <?php
    }
    ...
    for ($i = 1; $i <= $totalPagina; $i++) {
        if ($i >= ($pagina - 5) && $i <= ($pagina + 5)) {
            if ($i == $pagina) {
                ...
                echo "<li class='page-item'><a class='page-link' href=\"?menuop=eventos&paginaMedico={$i}\"> {$i} </a></li>";
            }
        }
    }
    ...
    ?>
        <li class="page-item"><a class="page-link" href="?menuop=eventos&paginaMedico=<?php echo $pagina + 1 ?>">>></a></li>
    <?php
    }

    echo "<li class='page-item'> <a class='page-link' href=\"?menuop=eventos&paginaMedico=$totalPagina\">Ultima Pagina</a></li>";
    ?>
</ul>
