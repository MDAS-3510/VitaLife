...
<header>
   <h3><i class="bi bi-person-square"> Pacientes</i></h3>
</header>

<div style="padding: 10px;">
   <a class="btn btn-outline-custom custom-btn mb-2" href="?menuop=cad-contato"><i class="bi bi-person-plus-fill"></i> Novo Paciente</a>
</div>
...
<ul class="pagination justify-content-center">
   ...
   echo '<li class="page-item"><a class="page-link" href="?menuop=contatos&paginaMedico=1">Primeira Pagina</a></li>';

   if ($pagina > 6) {
   ?>
      <li class="page-item"><a class="page-link" href="?menuop=contatos&paginaMedico=<?php echo $pagina - 1 ?>">
            <<< /a>
      </li>
   <?php
   }
   ...
   for ($i = 1; $i <= $totalPagina; $i++) {
      if ($i >= ($pagina - 5) && $i <= ($pagina + 5)) {
         if ($i == $pagina) {
            ...
            echo "<li class='page-item'><a class='page-link' href=\"?menuop=contatos&paginaMedico={$i}\"> {$i} </a></li>";
         }
      }
   }
   ...
   ?>
      <li class="page-item"><a class="page-link" href="?menuop=contatos&paginaMedico=<?php echo $pagina + 1 ?>">>></a></li>
   <?php
   }

   echo "<li class='page-item'> <a class='page-link' href=\"?menuop=contatos&paginaMedico=$totalPagina\">Ultima Pagina</a></li>";
   ?>
</ul>
