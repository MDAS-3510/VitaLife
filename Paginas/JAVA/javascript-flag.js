$(document).ready(function(){
    ...
    $('.flagFavoritoContato').click(function(){
        ...
        if(titulo === "Favorito"){
            ...
            $.getJSON('./paginas/contatos/contato.php?idContato='+idContato+'&flagFavoritoContato=0');
        }else{
            $(this).html('<i class="bi bi-star-fill"></i>').prop("title","Favorito");
            $.getJSON('./paginas/contatos/contato.php?idContato='+idContato+'&flagFavoritoContato=1');
        }
